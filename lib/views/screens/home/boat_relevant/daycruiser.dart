...
class RelevantDAYCRUISER extends GetView<ItemControllerImp> {
  const RelevantDAYCRUISER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = boatControllerImp.daycruiserdata;
    return Container(
