...
class RelevantTREBOAT extends GetView<ItemControllerImp> {
  const RelevantTREBOAT({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = boatControllerImp.treboatdata;
    return Container(
