...
class RelevantBOWRIDER extends GetView<ItemControllerImp> {
  const RelevantBOWRIDER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = boatControllerImp.bowriderdata;
    return Container(
