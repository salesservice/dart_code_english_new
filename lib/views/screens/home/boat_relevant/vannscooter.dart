...
class RelevantVANNSCOOTER extends GetView<ItemControllerImp> {
  const RelevantVANNSCOOTER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = boatControllerImp.vannscooterdata;
    return Container(
