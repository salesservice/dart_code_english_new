...
class RelevantSEILBOAT extends GetView<ItemControllerImp> {
  const RelevantSEILBOAT({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = boatControllerImp.seilboatdata;
    return Container(
