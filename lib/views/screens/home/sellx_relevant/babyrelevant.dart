...
class RelevantBABY extends GetView<ItemControllerImp> {
  const RelevantBABY({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    //Get.put(InnloggingControllerImp());
    FavoritController favcontroller = Get.put(FavoritController());
    SellxControllerImp sellxControllerImp = Get.put(SellxControllerImp());
    final List<dynamic> data = sellxControllerImp.babydata;
    return Container(
