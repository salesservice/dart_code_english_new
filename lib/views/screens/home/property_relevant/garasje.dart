...
class RelevantGARASJE extends GetView<ItemControllerImp> {
  const RelevantGARASJE({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.garasjedata;
    return Container(
