...
class RelevantLEILIGHET extends GetView<ItemControllerImp> {
  const RelevantLEILIGHET({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.leilighetdata;
    return Container(
