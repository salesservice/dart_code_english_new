...
class RelevantENEBOLIG extends GetView<ItemControllerImp> {
  const RelevantENEBOLIG({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.eneboligdata;
    return Container(
