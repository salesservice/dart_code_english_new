...
class RelevantGARDSBRUK extends GetView<ItemControllerImp> {
  const RelevantGARDSBRUK({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.gardsbrukdata;
    return Container(
