...
class RelevantBOLIGTILSALGS extends GetView<ItemControllerImp> {
  const RelevantBOLIGTILSALGS({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.boligtilsalgsdata;
    return Container(
