...
class RelevantREKKEHUS extends GetView<ItemControllerImp> {
  const RelevantREKKEHUS({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.rekkehusdata;
    return Container(
