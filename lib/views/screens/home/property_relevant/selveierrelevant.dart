...
class RelevantSELVEIER extends GetView<ItemControllerImp> {
  const RelevantSELVEIER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.selveierdata;
    return Container(
