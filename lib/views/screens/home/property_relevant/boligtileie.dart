...
class RelevantBOLIGTILLEIE extends GetView<ItemControllerImp> {
  const RelevantBOLIGTILLEIE({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = eiendomControllerImp.boligtileiedata;
    return Container(
