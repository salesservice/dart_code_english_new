...
class Relevant extends GetView<ItemControllerImp> {
  const Relevant({
    Key? key,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: GetBuilder<ItemControllerImp>(
        builder: (controller) => HandlingDataView(
          statusRequest: itemControllerImp.statusRequest,
          ...
          widget: GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              childAspectRatio: (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Sellx") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Båter") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Motorsykler") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Sykler") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Jobber") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Bøker") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Møbler") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Elektronikk") ||
                      (favcontroller.showRelevant1.value == false &&
                          itemControllerImp.katname == "Klær")
                  ? 2.7
                  : 1.2,
            ),
            itemBuilder: (context, index) {
