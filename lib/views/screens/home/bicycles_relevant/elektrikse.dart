...
class RelevantELEKTRISKE extends GetView<ItemControllerImp> {
  const RelevantELEKTRISKE({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.elektrisk;
    return Container(
