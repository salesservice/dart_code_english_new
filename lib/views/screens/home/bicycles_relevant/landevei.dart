...
class RelevantLANDEVEI extends GetView<ItemControllerImp> {
  const RelevantLANDEVEI({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.landevei;
    return Container(
