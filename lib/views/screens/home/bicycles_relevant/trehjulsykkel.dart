...
class RelevantTREHJULSYKKEL extends GetView<ItemControllerImp> {
  const RelevantTREHJULSYKKEL({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.trehjulsykkel;
    return Container(
