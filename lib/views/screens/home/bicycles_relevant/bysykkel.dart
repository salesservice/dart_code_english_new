...
class RelevantBYSYKKEL extends GetView<ItemControllerImp> {
  const RelevantBYSYKKEL({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.bysykkel;
    return Container(
