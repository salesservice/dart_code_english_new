...
class RelevantBARNESYKKEL extends GetView<ItemControllerImp> {
  const RelevantBARNESYKKEL({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.barnesykkel;
    return Container(
