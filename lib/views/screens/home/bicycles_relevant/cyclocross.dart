...
class RelevantCYCLOCROSS extends GetView<ItemControllerImp> {
  const RelevantCYCLOCROSS({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.cyclocross;
    return Container(
