...
class RelevantFULLDAMPER extends GetView<ItemControllerImp> {
  const RelevantFULLDAMPER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = sykkelControllerImp.fulldamper;
    return Container(
