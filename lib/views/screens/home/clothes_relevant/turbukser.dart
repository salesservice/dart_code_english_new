...
class RelevantTURBUKSER extends GetView<ItemControllerImp> {
  const RelevantTURBUKSER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = klarControllerImp.turbukserdata;
    return Container(
