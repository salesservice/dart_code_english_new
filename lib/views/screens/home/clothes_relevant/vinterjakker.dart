...
class RelevantVINTERJAKKER extends GetView<ItemControllerImp> {
  const RelevantVINTERJAKKER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = klarControllerImp.vinterjakkerdata;
    return Container(
