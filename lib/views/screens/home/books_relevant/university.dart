...
class RelevantUNIVERSITET extends GetView<ItemControllerImp> {
  const RelevantUNIVERSITET({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = bokerControllerImp.universitet;
    return Container(
