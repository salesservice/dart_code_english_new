...
class RelevantVIDEREGOENDE extends GetView<ItemControllerImp> {
  const RelevantVIDEREGOENDE({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = bokerControllerImp.videregoende;
    return Container(
