...
class RelevantBARNEBOKER extends GetView<ItemControllerImp> {
  const RelevantBARNEBOKER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = bokerControllerImp.barneboker;
    return Container(
