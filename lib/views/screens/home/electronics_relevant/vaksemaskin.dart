...
class RelevantVASKEMASKIN extends GetView<ItemControllerImp> {
  const RelevantVASKEMASKIN({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.vaskemaskindata;
    return Container(
