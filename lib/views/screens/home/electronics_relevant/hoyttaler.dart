...
class RelevantHOYTTALER extends GetView<ItemControllerImp> {
  const RelevantHOYTTALER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.hoyttalerdata;
    return Container(
