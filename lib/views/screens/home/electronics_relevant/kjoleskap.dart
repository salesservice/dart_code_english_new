...
class RelevantKJOLESKAP extends GetView<ItemControllerImp> {
  const RelevantKJOLESKAP({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.kjoleskapdata;
    return Container(
