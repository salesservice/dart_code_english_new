...
class RelevantPCSKJERMER extends GetView<ItemControllerImp> {
  const RelevantPCSKJERMER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.pcskjermerdata;
    return Container(
