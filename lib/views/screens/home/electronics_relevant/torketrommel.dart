...
class RelevantTORKETROMMEL extends GetView<ItemControllerImp> {
  const RelevantTORKETROMMEL({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.torketrommeldata;
    return Container(
