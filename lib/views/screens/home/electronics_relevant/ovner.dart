...
class RelevantOVNER extends GetView<ItemControllerImp> {
  const RelevantOVNER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.ovnerdata;
    return Container(
