...
class RelevantMIKROBOLGEOVN extends GetView<ItemControllerImp> {
  const RelevantMIKROBOLGEOVN({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.mikrobolgeovndata;
    return Container(
