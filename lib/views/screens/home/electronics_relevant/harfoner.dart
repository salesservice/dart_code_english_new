...
class RelevantHARFONER extends GetView<ItemControllerImp> {
  const RelevantHARFONER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.harfonerdata;
    return Container(
