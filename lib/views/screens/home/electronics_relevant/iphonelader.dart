...
class RelevantIPHONELADER extends GetView<ItemControllerImp> {
  const RelevantIPHONELADER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.iphoneladerdata;
    return Container(
