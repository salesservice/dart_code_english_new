...
class RelevantVRBRILLER extends GetView<ItemControllerImp> {
  const RelevantVRBRILLER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = elektronikkControllerImp.vrbrillerdata;
    return Container(
