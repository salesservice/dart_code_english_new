...
class RelevantSTOLER extends GetView<ItemControllerImp> {
  const RelevantSTOLER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = moblerControllerImp.stolerdata;
    return Container(
