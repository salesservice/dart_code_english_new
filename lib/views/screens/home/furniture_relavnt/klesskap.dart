...
class RelevantKLESSKAP extends GetView<ItemControllerImp> {
  const RelevantKLESSKAP({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = moblerControllerImp.klesskapdata;
    return Container(
