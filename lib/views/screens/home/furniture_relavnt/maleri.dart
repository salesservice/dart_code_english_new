...
class RelevantMALERIER extends GetView<ItemControllerImp> {
  const RelevantMALERIER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = moblerControllerImp.malerierdata;
    return Container(
