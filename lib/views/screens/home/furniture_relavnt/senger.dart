...
class RelevantSENGER extends GetView<ItemControllerImp> {
  const RelevantSENGER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = moblerControllerImp.sengerdata;
    return Container(
