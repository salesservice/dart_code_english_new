...
class RelevantSPISEBORD extends GetView<ItemControllerImp> {
  const RelevantSPISEBORD({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = moblerControllerImp.spiseborddata;
    return Container(
