...
class RelevantMOTORSYKLER extends GetView<ItemControllerImp> {
  const RelevantMOTORSYKLER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = mcControllerImp.motorsyklerdata;
    return Container(
