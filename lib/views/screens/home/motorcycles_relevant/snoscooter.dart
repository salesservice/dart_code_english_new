...
class RelevantSNOSCOOTER extends GetView<ItemControllerImp> {
  const RelevantSNOSCOOTER({Key? key}) : super(key: key);
...
class Relevant1 extends GetView<ItemControllerImp> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = mcControllerImp.snoscooterdata;
    return Container(
