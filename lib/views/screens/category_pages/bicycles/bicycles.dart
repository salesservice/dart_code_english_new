...
import 'package:flutter_isell_new/controller/items/bicycle_contoller.dart';
...
class SyklerHoved extends StatefulWidget {
  const SyklerHoved({Key? key}) : super(key: key);

  @override
  _BilerHovedState createState() => _BilerHovedState();
}

class _BilerHovedState extends State<SyklerHoved> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    BicycleControllerImp sykkelControllerImp = Get.put(BicycleControllerImp());
    BestitemsCarControllerImp bestitemsCarControllerImp =
        Get.put(BestitemsCarControllerImp());
    final List<dynamic> data = bestitemsCarControllerImp.bestitemssyklerdata;
    ...
    return GetBuilder<StoriControllerImp>(
      builder: (controller) => HandlingDataView(
          ...
          widget: GetBuilder<BicycleControllerImp>(
                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                sykkelControllerImp.toggleCategory(index);
                              },
                              child: Container(
                                padding:
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        ...
                                        width:
                                            sykkelControllerImp.selectedIndex ==
                                                    index
                                                ? 1.5
                                                : 0.5),
                                ...
                                child: Center(
                                  child: Text(
                                    sykkelControllerImp.sykkeltype[index],
                      ...
                      sykkelControllerImp.selectedIndex != -1 &&
                              sykkelControllerImp
                          ...
                          ? Container(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    sykkelControllerImp.buildRelevantName(
                                        sykkelControllerImp.selectedIndex),
                      ...
                      sykkelControllerImp.selectedIndex != -1
                          ? Container(
                              ...
                              child: MediaQuery.removePadding(
                                ...
                                removeBottom: true,
                                context: context,
                                child: sykkelControllerImp.buildRelevantView(
                                    sykkelControllerImp.selectedIndex),
                              ),
                            )
                          : const SizedBox(),
