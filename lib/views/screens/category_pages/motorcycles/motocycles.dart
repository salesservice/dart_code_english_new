...
import 'package:flutter_isell_new/controller/items/motorcycle_controller.dart';
...
class MCHoved extends StatefulWidget {
  const MCHoved({Key? key}) : super(key: key);

  @override
  _BilerHovedState createState() => _BilerHovedState();
}

class _BilerHovedState extends State<MCHoved> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    MCControllerImp mcControllerImp = Get.put(MCControllerImp());
    BestitemsCarControllerImp bestitemsCarControllerImp =
        Get.put(BestitemsCarControllerImp());
    final List<dynamic> data = bestitemsCarControllerImp.bestmcitemsdata;
    ...
    return GetBuilder<StoriControllerImp>(
      builder: (controller) => HandlingDataView(
          ...
          widget: GetBuilder<MCControllerImp>(
                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                mcControllerImp.toggleCategory(index);
                              },
                              child: Container(
                                padding:
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        ...
                                        width: mcControllerImp.selectedIndex ==
                                                index
                                            ? 1.5
                                            : 0.5),
                      ...
                      mcControllerImp.selectedIndex != -1 &&
                              mcControllerImp
                          ...
                          ? Container(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    mcControllerImp.buildRelevantName(
                                        mcControllerImp.selectedIndex),
                      ...
                      mcControllerImp.selectedIndex != -1
                          ? Container(
                              ...
                              child: MediaQuery.removePadding(
                                ...
                                removeBottom: true,
                                context: context,
                                child: mcControllerImp.buildRelevantView(
                                    mcControllerImp.selectedIndex),
                              ),
                            )
                          : const SizedBox(),
