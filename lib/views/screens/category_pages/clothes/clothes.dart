...
class KlarHoved extends StatefulWidget {
  const KlarHoved({Key? key}) : super(key: key);

  @override
  _BilerHovedState createState() => _BilerHovedState();
}

class _BilerHovedState extends State<KlarHoved> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = bestitemsCarControllerImp.besteitemsklardata;
    ...
    return GetBuilder<StoriControllerImp>(
        builder: (controller) => HandlingDataView(
            ...
            widget: GetBuilder<KlarControllerImp>(
              builder: (controller) => Stack(
                children: [
                  SingleChildScrollView(
                    child: Column(
                      children: [
                        GetBuilder<StoriControllerImp>(
                        ...
                        Container(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  klarControllerImp.toggleCategory(index);
                                },
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          ...
                                          width:
                                              klarControllerImp.selectedIndex ==
                                                      index
                                                  ? 1.5
                                                  : 0.5),
                                  ...
                                  child: Center(
                                    child: Text(
                                      klarControllerImp.klartype[index],
                        ...
                        klarControllerImp.selectedIndex != -1 &&
                                klarControllerImp
                            ...
                            ? Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      klarControllerImp.buildRelevantName(
                                          klarControllerImp.selectedIndex),
                        ...
                        klarControllerImp.selectedIndex != -1
                            ? Container(
                                ...
                                child: MediaQuery.removePadding(
                                  ...
                                  removeBottom: true,
                                  context: context,
                                  child: klarControllerImp.buildRelevantView(
                                      klarControllerImp.selectedIndex),
                                ),
                              )
                            : const SizedBox(),
