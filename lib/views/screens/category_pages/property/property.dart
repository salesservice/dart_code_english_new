...
class EiendomHoved extends StatefulWidget {
  const EiendomHoved({Key? key}) : super(key: key);

  @override
  _BilerHovedState createState() => _BilerHovedState();
}

class _BilerHovedState extends State<EiendomHoved> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> data = bestitemsCarControllerImp.besteboligdata;
    ...
    return GetBuilder<StoriControllerImp>(
      builder: (controller) => HandlingDataView(
          ...
          widget: GetBuilder<PropertyControllerImp>(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: eiendomControllerImp.eieendomtyper.length,
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                eiendomControllerImp.toggleCategory(index);
                              },
                              child: Container(
                                padding:
                                ...
                                child: Center(
                                  child: Text(
                                    eiendomControllerImp.eieendomtyper[index],
                      ...
                      eiendomControllerImp.selectedIndex != -1 &&
                              eiendomControllerImp
                          ...
                          ? Container(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    eiendomControllerImp.buildRelevantName(
                                        eiendomControllerImp.selectedIndex),
                      ...
                      eiendomControllerImp.selectedIndex != -1
                          ? Container(
                              ...
                              child: MediaQuery.removePadding(
                                ...
                                removeBottom: true,
                                context: context,
                                child: eiendomControllerImp.buildRelevantView(
                                    eiendomControllerImp.selectedIndex),
                              ),
                            )
                          : const SizedBox(),
