...
class SearchfavList extends GetView<HomePageControllerImp> {
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        title: Text("Bekreft sletting",
                            style:
                                GoogleFonts.baloo2(color: Myisellcolors.hvit)),
                        content: Text(
                        ...
                        actions: [
                          ...
                          TextButton(
                            ...
                            onPressed: () {
                              if (favcontroller.isFavorite[itemsModel.itemId] ==
                                  1) {
                                favcontroller.setFavorite(itemsModel.itemId, 0);
                                favcontroller.removeFavoritt(itemsModel.itemId);
                                itemsModel.itemLikt = itemsModel.itemLikt! - 1;
                                favcontroller.itemlikt(
