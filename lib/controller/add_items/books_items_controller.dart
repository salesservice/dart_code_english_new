...
class AddBokerAnnonseController extends GetxController {
  StatusRequest statusRequest = StatusRequest.none;
  GlobalKey<FormState> gkBokerannonse = GlobalKey<FormState>();
  ...
  TextEditingController? bokkategori;
  //TextEditingController? imagename;

  AddBokerAnnonseController() {
    annonsetype = "Selge";
  ...
  initialData() {
    ...
    bokkategori = TextEditingController();
  ...
  addBokerAnnonseData() async {
    var formdata = gkBokerannonse.currentState;
    if (formdata!.validate()) {
      statusRequest = StatusRequest.loading;
      update();
      var response = await booksItemsData.addData(
