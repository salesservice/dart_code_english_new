...
class AddKlarAnnonseController extends GetxController {
  StatusRequest statusRequest = StatusRequest.none;
  GlobalKey<FormState> gkKlarannonse = GlobalKey<FormState>();
  ...
  addKlarAnnonseData() async {
    var formdata = gkKlarannonse.currentState;
    if (formdata!.validate()) {
      statusRequest = StatusRequest.loading;
      update();
      var response = await clothesItemData.addData(
