...
class AddMoblerAnnonseController extends GetxController {
  StatusRequest statusRequest = StatusRequest.none;
  GlobalKey<FormState> gkMoblerannonse = GlobalKey<FormState>();
  ...
  addMoblerAnnonseData() async {
    var formdata = gkMoblerannonse.currentState;
    if (formdata!.validate()) {
      statusRequest = StatusRequest.loading;
      update();
      var response = await furnitureItemData.addData(
